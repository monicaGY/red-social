...
<body class="border-opacity-10 bg-opacity-10 bg-dark bg-gradient d-flex overflow-hidden" style="max-width:1000px; margin:auto;" >
    ...
    <div id="tDivChats" class="bg-opacity-50 bg-light bg-gradient flex-column overflow-hidden flex-grow-1" >
        <div class=" border-bottom border-3 text-light border-light gap-3 bg-primary p-2 d-flex align-items-center justify-content-center" style="height:70px">
    ...
    <div id="ventanaChat" class="border-end border-start border-light border-3 d-none overflow-hidden 
        ...
        <div id="header-contacto" class="border-light border-bottom border-3 align-items-center p-2 
        gap-3 d-flex bg-primary text-light" style="height:70px">
            <div id="regresar-atras">
                <img class="d-block d-sm-none" src="../src/atras.png" width="50">
        ...
        <div id="contenedor-mensajes" class="overflow-auto flex-grow-1 d-flex flex-column" style ="height:100%;">
        </div>
        
        <!-- <div id="formEnviarMensaje mx-2" class=" d-inline-flex" >

            
            <textarea id="tTxTareaMensaje" placeholder="Escribe . . ." class="row-2 rounded-5 form-control" style="height:50px"></textarea>
    ...
    <div id="tDivAlert" class="d-none border border-3 border-light flex-grow-1 bg-dark w-25 bg-opacity-25 d-flex align-items-center justify-content-center">
